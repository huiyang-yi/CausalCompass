...
from causalcompass.algorithms.causalnex.structure.pytorch.dist_type.categorical import DistTypeCategorical
from causalcompass.algorithms.causalnex.structure.pytorch.sklearn._base import DAGBase
...
class DAGClassifier(ClassifierMixin, DAGBase):
    ...
    Example:
    ::
        >>> from causalcompass.algs.causalnex.sklearn import DAGRegressor
        >>>
