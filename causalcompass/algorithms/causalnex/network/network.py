...
from causalcompass.algorithms.causalnex.estimator.em import EMSingleLatentVariable
from causalcompass.algorithms.causalnex.structure import StructureModel
from causalcompass.algorithms.causalnex.utils.pgmpy_utils import pd_to_tabular_cpd
...
class BayesianNetwork:
    ...
    ::
        ...
        >>> from causalcompass.algs.causalnex.structure import StructureModel
        >>> from causalcompass.algs.causalnex.network import BayesianNetwork
        >>>
        >>> sm = StructureModel()
        >>> sm.add_edges_from([
        >>>                    ('rush_hour', 'traffic'),
