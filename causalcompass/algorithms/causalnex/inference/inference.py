...
from causalcompass.algorithms.causalnex.ebaybbn import build_bbn
...
class InferenceEngine:
    ...
    ::
        ...
        >>> from causalcompass.algs.causalnex.structure.structuremodel import StructureModel
        >>> from causalcompass.algs.causalnex.network import BayesianNetwork
        >>> from causalcompass.algs.causalnex.inference import InferenceEngine
        >>>
        >>> sm = StructureModel()
        >>> sm.add_edges_from([
        >>>                    ('rush_hour', 'traffic'),
